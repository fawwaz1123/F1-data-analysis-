...
class database:
    ...
    def __init__(self):
        ...
        self.__driver_standings = pd.read_csv("driver_standings")
        ...
        self.__contructor_standings = pd.read_csv("constructor_standings")
        self.__constructor_results = pd.read_csv("constructor_standings.csv")
        self.__pitstops = pd.read_csv("pitstops.csv")
